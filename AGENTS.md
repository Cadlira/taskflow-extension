...
44. Antes do commit final do archive, valide em conjunto que a pasta ativa da Change deixou de existir, o diretório arquivado e as specs consolidadas existem, a linha correspondente no roadmap contém `DONE`, `ARCHIVED` e a data de conclusão e o README descreve somente comportamentos e estados efetivamente atuais. Qualquer divergência bloqueia o archive e o merge.
