...
- [x] 7.2 Executar o fluxo manual no Chrome para Quick Add, CRUD, pesquisa/filtros, sincronização popup/Side Panel e pelo menos um lembrete, registrando o resultado da verificação na Change antes de marcá-la concluída.
