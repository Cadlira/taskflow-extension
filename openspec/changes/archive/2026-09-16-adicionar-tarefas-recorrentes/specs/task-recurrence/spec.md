...
O sistema SHALL permitir encerrar a série a partir da ocorrência aberta, removendo a regra e mantendo a tarefa como tarefa comum. Excluir a ocorrência que carrega a regra SHALL encerrar a série, e a confirmação de exclusão SHALL informar essa consequência.
...
- **AND** a tarefa é removida e nenhuma ocorrência nova é criada
