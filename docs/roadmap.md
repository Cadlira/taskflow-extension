...
`TF-001`, `TF-002`, `TF-002.1`, `TF-003` e `TF-004` estão concluídas. A `TF-005` foi aprovada e está em verificação.
...
| `TF-005` | `adicionar-lembretes-personalizados`     | `IN_PROGRESS`       | `VERIFY`  | `2026-09-15`   | —                 | Lembretes de `TF-001`                           | Verificação antes do PR         |
