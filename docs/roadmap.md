...
`TF-001`, `TF-002`, `TF-002.1`, `TF-003`, `TF-004`, `TF-005`, `TF-006`, `TF-007`, `TF-008` e `TF-014` estão concluídas. A `TF-009` foi adiada em `2026-09-18` por falta de uso real; a próxima Change elegível é a `TF-010`.
